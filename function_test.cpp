...
int main() {
    ...
    */
    Eigen::Matrix<T,N,1> x_stationary;
    solve_system<T,TP,N,NP>(x,p,x_stationary);

    Eigen::Matrix<T,N,1> y_stationary;
    F<T,TP,N,NP>(x_stationary,p,y_stationary);

    Eigen::Matrix<T,N,N> ddydxx;
    dF<T,TP,N,NP>(x_stationary,p,y_stationary,ddydxx);
