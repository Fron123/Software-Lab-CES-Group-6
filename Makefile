...
LIBNLS_INC_DIR=$(BASE_DIR)/include
...
%.o : %.cpp
	$(COMPILER)  -I$(EIGEN_DIR) -I$(DCO_INC_DIR) -I$(COLPACK_INC_DIR) -I$(COLPACK_SRC_GGC) -I$(COLPACK_SRC_BGC) -I$(COLPACK_SRC_BGPC) -I$(COLPACK_SRC_U) -I$(COLPACK_SRC_R) -I$(COLPACK_SRC_SMPGC) -I$(LIBNLS_INC_DIR) -L$(DCO_LIB_DIR) $(CCFLAGS) -c $< -o $@ -l$(DCO_LIB)

$(EXE): $(OBJ)
	$(COMPILER) $^ -I$(EIGEN_DIR) -I$(DCO_INC_DIR) -I$(COLPACK_INC_DIR) -I$(COLPACK_SRC_GGC) -I$(COLPACK_SRC_BGC) -I$(COLPACK_SRC_BGPC) -I$(COLPACK_SRC_U) -I$(COLPACK_SRC_R) -I$(COLPACK_SRC_SMPGC) -I$(LIBNLS_INC_DIR) -L$(DCO_LIB_DIR) $(CCFLAGS) -o $@ -l$(DCO_LIB)
